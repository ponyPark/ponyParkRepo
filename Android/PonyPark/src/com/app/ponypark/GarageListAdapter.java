...
public class GarageListAdapter extends ArrayAdapter<GarageEntry> {

	private ArrayList<GarageEntry> itemList;
	private Context context;

	public GarageListAdapter(ArrayList<GarageEntry> itemList, Context ctx) {
